...
public class TestTimeInterval {
  ...
  private static final DateTimeZone IST =
      DateTimeZone.forTimeZone(TimeZone.getTimeZone("GMT+5:30"));
  // Daylight savings time zone
  private static final DateTimeZone PDT =
  ...
  public void testDurationStartOfInterval(
      DateTime eventTime, int intervalMillis, DateTimeZone tz, DateTime expectedValue)
      throws Exception {
    TimeInterval timeInterval =
        intervalMillis == 0
            ? TimeInterval.INFINITE
            : intervalMillis == -1 ? TimeInterval.ZERO : TimeInterval.withMillis(intervalMillis);
    Assert.assertEquals(timeInterval.getIntervalStart(eventTime.withZone(tz)), expectedValue);
              ...
              new Object[][] {
                {
                  ...
                  5,
                  new DateTime(2011, 8, 9, 14, 35, 10, 0, timeZone)
                },
                {
                  time,
                  TimeIntervalType.SECOND,
                  6,
                  new DateTime(2011, 8, 9, 14, 35, 12, 0, timeZone)
                },
                {
                ...
                },
                {
                  ...
                  TimeIntervalType.SECOND,
                  30,
                  new DateTime(2011, 8, 9, 14, 35, 0, 0, timeZone)
                },
                {
              ...
              new Object[][] {
                {
                  ...
                  TimeIntervalType.SECOND,
                  5,
                  new DateTime(2012, 11, 4, 23, 35, 10, 0, timeZone)
                },
                {
                  time,
                  TimeIntervalType.SECOND,
                  6,
                  new DateTime(2012, 11, 4, 23, 35, 12, 0, timeZone)
                },
                {
                  time,
                  TimeIntervalType.SECOND,
                  7,
                  new DateTime(2012, 11, 4, 23, 35, 7, 0, timeZone)
                },
                {
                  time,
                  TimeIntervalType.SECOND,
                  30,
                  new DateTime(2012, 11, 4, 23, 35, 0, 0, timeZone)
                },
                {
                  time,
                  TimeIntervalType.MINUTE,
                  6,
                  new DateTime(2012, 11, 4, 23, 30, 0, 0, timeZone)
                },
  ...
  public void testPeriodStartOfInterval(
      DateTime eventTime, TimeIntervalType intervalType, int length, DateTime expectedValue)
      throws Exception {
  ...
  public void testIntervalLengthOutOfBounds(
      TimeIntervalType intervalType, DateTimeZone timeZone, long length) {
  ...
  public void testValidIntervalLength(
      TimeIntervalType intervalType, DateTimeZone timeZone, int length, long millisValue) {
    intervalType.validateValue(timeZone, length);
    Assert.assertEquals(
        TimeInterval.withTypeAndLength(intervalType, length).toApproxMillis(), millisValue);
  }
  ...
  public Object[][] plusMinus() {
    ...
    return new Object[][] {
      ...
      {
        testTime,
        TimeInterval.withMillis(24 * 60 * 60 * 1000),
        new DateTime(2011, 3, 14, 1, 29, 10, 101, PDT),
        1
      },
  ...
  public void testIntervalPlusMinus(
      DateTime before, TimeInterval interval, DateTime after, int multiple) {
    ...
    for (int i = 0; i < intervals.length; i++) {
      ...
      for (int j = 0; j < intervals.length; j++) {
        ...
        if (i == j) {
          ...
          Assert.assertTrue(
              interval1.hashCode() != interval2.hashCode()
