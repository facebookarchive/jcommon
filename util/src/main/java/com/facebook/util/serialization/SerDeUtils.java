...
public class SerDeUtils {
  ...
  public static <T> ByteBuffer serializeToByteBuffer(T value, Serializer<T> serializer)
      throws SerDeException {
    return ByteBuffer.wrap(serializeToBytes(value, serializer));
  }

  public static <T> T deserializeFromBytes(byte[] bytes, Deserializer<T> deserializer)
      throws SerDeException {
  ...
  public static <T> T deserializeFromByteBuffer(ByteBuffer buffer, Deserializer<T> deserializer)
      throws SerDeException {
