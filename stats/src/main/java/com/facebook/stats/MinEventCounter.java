...
public class MinEventCounter extends AssociativeAggregationCounter {
  public static final AssociativeAggregation AGGREGATION = (l1, l2) -> Math.min(l1, l2);

  public MinEventCounter(ReadableDateTime start, ReadableDateTime end, long initialValue) {
