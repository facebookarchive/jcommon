...
public interface CliConverter<T> {
  public static CliConverter<String> STRING = value -> value;
  public static CliConverter<Integer> INT = value -> value == null ? null : Integer.parseInt(value);
  ...
  public static CliConverter<Boolean> BOOLEAN =
      value -> value == null ? null : Boolean.valueOf(value);
