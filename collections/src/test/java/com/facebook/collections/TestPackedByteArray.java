...
public class TestPackedByteArray {
  ...
  public void testCompare1() throws Exception {
    // {2, 3, 3}
    byte[] bytes1 = PackedByteArray.packComparable(original[0]);
    // {2, 3, 2}
    byte[] bytes2 = PackedByteArray.packComparable(original[1]);
    // => -1
  ...
  public void testCompare2() throws Exception {
    // { {0, 0, 1} }
    byte[] bytes1 = PackedByteArray.packComparable(original[1]);
    // {{0, 1}, {0} }
    byte[] bytes2 = PackedByteArray.packComparable(original[5], original[6]);
    // => 1
    Assert.assertEquals(Lists.compareArrays(bytes1, bytes2), 1);
  }
