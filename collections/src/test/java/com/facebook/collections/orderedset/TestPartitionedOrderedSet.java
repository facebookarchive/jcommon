...
public class TestPartitionedOrderedSet {

  private PartitionedOrderedSet<IntRange> partitionedHeap;
  ...
  public void setUp() throws Exception {
    ...
    partitionedHeap = new PartitionedOrderedSet<>(orderedSetPartitions, IntRange.getSizeComparator());
