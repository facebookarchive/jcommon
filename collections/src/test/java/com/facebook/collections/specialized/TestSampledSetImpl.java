...
public class TestSampledSetImpl {
  ...
  public void testSanity() throws Exception {
    ...
    float error = Math.abs(largeSet.getScaledSize() - numElements) / (float) numElements;
    String message =
        String.format(
            "actual: %d estimate: %d error: %f", numElements, largeSet.getScaledSize(), error);
  ...
  private void assertValidMaxSize() {
    Assert.assertTrue(
        ...
        String.format("max size %d exceeded at %d", maxSetSize, integerSet.getSize()));
  }
  ...
  public void testMerge() throws Exception {
    ...
    int maxofMaxSetSize = Math.max(integerSet.getMaxSetSize(), otherSet.getMaxSetSize());
    Assert.assertEquals(mergeIntoFirst.getMaxSetSize(), maxofMaxSetSize);
