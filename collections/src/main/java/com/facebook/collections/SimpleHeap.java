...
/**
 * @param <T> type being held. Implementations will require that T extend Comparable or provide a
 *     Comparator
 */
public interface SimpleHeap<T> extends Iterable<T> {
   ...
   *
   * <p>if implemented, shrinks the heap's memory footprint as much as possible
   *
   * @return may return the # of slots or bytes saved. A return value of 0 need not indicate 0
   *     saved, per see. See implementation's documentation
   */
  public int shrink();
