...
public class TestUnstoppableExecutorService {
  ...
  public void testAwaitTerminationForExecute() throws Exception {
    ...
    AtomicInteger completed = TestUtils.countCompletedRunnables(10, executor::execute);
  ...
  public void testAwaitTerminationForSubmitRunnable1() throws Exception {
    ...
    AtomicInteger completed = TestUtils.countCompletedRunnables(10, executor::submit);
  ...
  public void testAwaitTerminationForSubmitRunnable2() throws Exception {
    ...
    AtomicInteger completed =
        TestUtils.countCompletedRunnables(10, argument -> executor.submit(argument, new Object()));
  ...
  public void testRate() throws Exception {
    ...
    // the queue
    LOG.info("%d tasks with %d threads took %f ms", numTasks, numThreads, timeTakenMillis);
