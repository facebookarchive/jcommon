...
public class TestOffHeapSlab {
  ...
  public void setUp() throws Exception {
    ...
    memoryViewController = new MemoryViewController(MemoryView32.factory(), new RawSlabAdapter(slab));
    byteViewSize = 2 * 1024 * 1024;
  }
  ...
  public void testPut() throws Exception {
    MemoryView memoryView = memoryViewController.allocate(byteViewSize);
