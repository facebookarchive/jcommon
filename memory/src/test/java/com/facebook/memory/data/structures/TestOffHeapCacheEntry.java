...
public class TestOffHeapCacheEntry {
  ...
  public void testSlots() throws Exception {
    ...
    Assert.assertEquals(nextSlotInfo.getSlotType(), SlotType.ADDRESS);
    Assert.assertEquals(nextSlotInfo.getOffset(0), 0);
    Assert.assertEquals(dataSlotInfo.getSlotType(), SlotType.ADDRESS);
    Assert.assertEquals(dataSlotInfo.getOffset(0), 8);
    Assert.assertEquals(previousSlotInfo.getSlotType(), SlotType.ADDRESS);
