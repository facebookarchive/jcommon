...
public abstract class AbstractMemoryView<T extends Comparable<T>> implements MemoryView {
  ...
  protected abstract void incrementCurrent(int value);

  @SuppressWarnings("AbstractMethodOverridesAbstractMethod")
  @Override
  public abstract MemoryView splice(long offset, long size);
  ...
  public MemoryView reset() {
    return splice(0, sizeAsLong());
  }

  @Override
  public MemoryView splice(long offset) {
    long spliceSize = sizeAsLong() - offset;

    return splice(offset, spliceSize);
  }
}
