...
public class DualAllocationPolicy implements AllocationPolicy {
  ...
  @Override
  public long allocate(SlabAllocationFunction allocationFunction)
    ...
    return secondPolicy.allocate(new PolicyUpdatingAllocationFunction(allocationFunction, firstPolicy));
  }
  ...
  public Allocation tryAllocate(SlabTryAllocationFunction tryAllocationFunction) {
    Allocation allocation = firstPolicy.tryAllocate(
      new PolicyUpdatingTryAllocationFunction(tryAllocationFunction, secondPolicy)
    );
