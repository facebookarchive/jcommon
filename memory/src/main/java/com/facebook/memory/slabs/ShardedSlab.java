...
public class ShardedSlab implements Slab {
  ...
  public ShardedSlab(SlabPool slabPool, AllocationPolicy allocationPolicy) {
  ...
  public long allocate(final long sizeBytes) throws FailedAllocationException {
    long address = allocationPolicy.allocate(
      new SlabAllocationFunction() {
        @Override
